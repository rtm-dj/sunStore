<template>
  <section class="components">
    ...
    <div class="components-wrapper">
      <img src="/curvedText_1.svg" alt="" class="curvedText">
      ...
      <div class="components-right-part">
        ...
        <div class="sliderNavigation">
          <div class="sliderArrow" @click="slider != 1 ? slider-- : slider = 3">
            <img src="/sliderArrowLeft.svg" alt="left">
          </div>
          <div class="counter">{{ slider + '/3' }}</div>
          <div class="sliderArrow" @click="slider != 3 ? slider++ : slider = 1">
            <img src="/sliderArrowRight.svg" alt="right">
          </div>
        </div>
      </div>
      <img style="display: none;" src="/curvedText_2.svg" alt="" class="curvedTextComponents">
    </div>
...
export default {
  setup() {
    useHead({
      ...
      link: [
        { rel: 'canonical', href: 'https://kladovayasun.ru/components' },
      ],
    })
  },
